...
This directory contains versioned Penpot snapshots and repository-side visual exports derived from the canonical design workspace.

## Purpose

These artifacts provide durable repository-side references for implementation, documentation, visual regression, and offline inspection without requiring immediate access to the live Penpot workspace.
...
Generated or disposable artifacts should remain outside the repository unless they are required for implementation, documentation, testing, or traceability.
